...
{
    return isset($_SESSION['estComptable']);
}
...
{
    return estVisiteur() or estComptable();
}


/**
 * Enregistre dans une variable session estComptable=true
 *
 *
 * @return null
 */

function connecterComptable($nom, $prenom)
{
